...
},
{
  ...
  async process(pathname, match) {
    ...
    const buffer = await store.get(key);
    const iv2 = new ImageView2(sharp(buffer));
    const out = await iv2.m(1).w(200).h(200).q(48).process();
    return out.toBuffer({
      resolveWithObject: true
    });
  },
...
},
{
  ...
  async process(pathname, match) {
    ...
    const buffer = await store.get(key);
    const iv2 = new ImageView2(sharp(buffer));
    const out = await iv2.m(1).w(parseInt(match[3])).h(parseInt(match[4])).q(48).process();
    return out.toBuffer({
      resolveWithObject: true
    });
  },
...
}, 
{
  ...
  async process(pathname, match) {
    ...
    const buffer = await store.get(key);
    const iv2 = new ImageView2(sharp(buffer));
    const out = await iv2.m(1).w(parseInt(match[5])).h(parseInt(match[6])).process();
    return out.toBuffer({
      resolveWithObject: true
    });
  },
...
},
{
  ...
  async process(pathname, match) {
    ...
    const buffer = await store.get(key);
    const iv2 = new ImageView2(sharp(buffer));
    const out = await iv2.m(1).w(parseInt(match[5])).h(parseInt(match[6])).q(48).process();
    return out.toBuffer({
      resolveWithObject: true
    });
  },
...
}, 
{
  ...
  async process(pathname, match) {
    ...
    const buffer = await store.get(key);
    const iv2 = new ImageView2(sharp(buffer));
    const out = await iv2.m(2).w(parseInt(match[5])).h(parseInt(match[6])).process();
    return out.toBuffer({
      resolveWithObject: true
    });
  },
...
},
{
  ...
  async process(pathname, match) {
    ...
    const buffer = await store.get(key);
    const iv2 = new ImageView2(sharp(buffer));
    const out = await iv2.m(2).w(parseInt(match[5])).h(parseInt([6])).q(48).process();
    return out.toBuffer({
      resolveWithObject: true
    });
  },
...
},
{
  ...
  async process(pathname, match) {
    ...
    const buffer = await store.get(key);
    const iv2 = new ImageView2(sharp(buffer));
    const out = await iv2.m(2).w(parseInt(match[4])).h(parseInt(match[5])).process();
...
},
{
  ...
  async process(pathname, match) {
    ...
    const buffer = await store.get(key);
    const iv2 = new ImageView2(sharp(buffer));
    const out = await iv2.m(2).w(parseInt(match[4])).h(parseInt(match[5])).q(48).process();
    return out.toBuffer({
      resolveWithObject: true
    });
  },
},
{
  ...
  async process(pathname, match) {
    ...
    const buffer = await store.get(key);
    const iv2 = new ImageView2(sharp(buffer));
    const out = await iv2.m(2).w(parseInt(match[2])).h(parseInt(match[3])).process();
    return out.toBuffer({
      resolveWithObject: true
    });
  },
...
},
{
  ...
  async process(pathname, match) {
    ...
    const buffer = await store.get(key);
    const iv2 = new ImageView2(sharp(buffer));
    const out = await iv2.m(2).w(parseInt(match[2])).h(parseInt(match[3])).q(48).process();
    return out.toBuffer({
      resolveWithObject: true
    });
  },
